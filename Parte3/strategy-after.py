...
class FIFOOrderingStrategy(estrategia_orden_ticket):
    def create_ordering(self, list: List[SupportTicket]) -> List[SupportTicket]:
        return list.copy()


class FILOOrderingStrategy(estrategia_orden_ticket):
    def create_ordering(self, list: List[SupportTicket]) -> List[SupportTicket]:
        list_copy = list.copy()
        list_copy.reverse()
        return list_copy
...
class RandomOrderingStrategy(estrategia_orden_ticket):
    def create_ordering(self, list: List[SupportTicket]) -> List[SupportTicket]:
        list_copy = list.copy()
...
class BlackHoleStrategy(estrategia_orden_ticket):
    def create_ordering(self, list: List[SupportTicket]) -> List[SupportTicket]:
        return []
